...
```
CREATE DATABASE nest-postgres;
```

("Replace 'nest-postgres' with your preferred database name, and make sure to use that same name in your .env file."). Tables will be auto generated.
